    ...
    return (
        <div className='header w-100 h3'>
            <div className='flex headflex justify-between items-center w-90 center'>
                <div className='logoheader w4'><a className='link' href="https://moyyn.com/"><img className="Logo" src="https://app.moyyn.com/static/media/Logo.ed17c448.png" alt="Moyyn"/>{/*<h3 className='white logo f4'>Moyyn</h3>*/}</a></div>
